...
class Profile extends React.Component {
 ...
 <Jumbotron fluid style={{ backgroundColor: "rgb(223, 206, 180)" }} >
        ...
        <div  style={{
          ...
          <div>
            <h3 style={{ marginLeft: "40%", marginTop: "3%", fontFamily: "serif" }}>My recipes:</h3>
        <Accordion className="accordion" style={{width:"800px", margin:" 0 75px"}}>
          <Card >
          ...
          <div>
            <h3 style={{ marginLeft: "35%", marginTop: "3%", fontFamily: "serif" }}>My favourite:</h3>
        <Accordion className="accordion" style={{width:"800px", margin:" 0 10px"}}>
          <Card >
            <Card.Header style={{backgroundColor:"rgb(255, 234, 217)" }}>
              <Accordion.Toggle as={Button} variant="link" eventKey="0">
               <p style={{fontFamily: "serif", }}>First recipe</p> 
        ...
        <div className="container">
          <div className="row clearfix">
            <div className="col-md-12 column">
              ...
              <button onClick={this.handleAddRow} className="btn btn-outline-danger btn-sm">
                Add Row
              </button>
            </div>
          </div>
  ...
  render() {
    return (
      <div style={{ backgroundColor: "rgb(223, 206, 180)" }}>
        <div ><h2 style={{textAlign:"center", fontWeight: "bold", fontStyle: "italic", fontSize: "30px", fontFamily: "serif"}}>Add a new recipe here!</h2></div>
