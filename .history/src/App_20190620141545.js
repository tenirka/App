...
class Recipes extends React.Component {
  render() {
    return (
      ...
      <button style={{float:"right", marginRight:"10%", marginTop:"-45px", borderRadius:"1.25rem", border:"1px solid rgb(172, 112, 0)", backgroundColor:"rgb(238, 89, 89)"}}>
        <Link to="/add" style={{ fontWeight: "800", color:"white",  fontStyle: "italic", fontSize: "20px"}}
                > Add recipe</Link>
                </button>
      <RecipesList/>
      <RecipesList/>
        ...
        <Navbar style={sectionStyle} className="navbar">
          <Navbar.Brand>
            ...
            <Nav className="mr-auto" style={{marginLeft:"700px"}}>
              <button variant="link" style={{backgroundColor: "rgb(243, 223, 193)", margin:"25px", marginRight:"10px", border:"1px solid rgb(155, 104, 63)", borderRadius:"1.25rem" }}>
               <Link to="/profile" style={{ fontWeight: "800", color:"rgb(12, 9, 3)",  fontStyle: "italic",
                fontSize: "20px"}}> Profile </Link>
            </button>

            <button variant="link" style={{backgroundColor: "rgb(243, 223, 193)", margin:"25px", marginLeft:"10px", border:"1px solid rgb(155, 104, 63)", borderRadius:"1.25rem" }}>
