...
class Footer extends React.Component {
  render() {
    return (
      ...
      >
        <Container style={{margin:"5px", width="200px"}}>
          <div >
             <p style={{color:"rgb(129, 131, 126)", textAlign:"start"}}>
            Here you will find many new culinary ideas, become the author of
            your own Culinary Book, meet like-minded friends and you can chat
