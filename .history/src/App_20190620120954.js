      ...
      <header>
        <Navbar style={sectionStyle} className="navbar">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <button variant="outline-secondary" style={{backgroundColor:"black", margin:"25px", border:"none", borderBottom:"1px" }}>
            <Link to="/sign-in" style={{fontWeight: "bold", color:"white"}}>Sign in</Link>
            </button>
            <Form inline>
              <FormControl
                type="text"
