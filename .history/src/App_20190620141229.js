        ...
        <Navbar style={sectionStyle} className="navbar">
          <Navbar.Brand>
            ...
            <Nav className="mr-auto" style={{marginLeft:"700px"}}>
              <button variant="link" style={{backgroundColor: "rgb(243, 223, 193)", margin:"25px", marginRight:"10px", border:"1px", borderRadius:"1.25rem" }}>
               <Link to="/profile" style={{ fontWeight: "800", color:"rgb(12, 9, 3)",  fontStyle: "italic",
                fontSize: "20px"}}> Profile </Link>
            </button>

            <button variant="link" style={{backgroundColor: "rgb(243, 223, 193)", margin:"25px", marginLeft:"10px", border:"1px", borderRadius:"1.25rem" }}>
