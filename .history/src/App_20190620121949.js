      ...
      <header>
        <Navbar style={sectionStyle} className="navbar">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <button variant="link" style={{backgroundColor: "rgb(243, 223, 193)", margin:"25px", border:"1px solid rgb(243, 223, 193)",  }}>
              <Link to="/sign-in" style={{fontWeight: "800", color:"white",  fontStyle: "italic",
