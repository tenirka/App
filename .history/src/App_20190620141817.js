...
class Recipes extends React.Component {
  render() {
    return (
      ...
      <button style={{float:"right", marginRight:"10%", marginTop:"-45px", borderRadius:"1.25rem", border:"1px solid #cccccc", backgroundColor:"rgb(238, 89, 89)"}}>
        <Link to="/add" style={{ fontWeight: "800", color:"white",  fontStyle: "italic", fontSize: "19px", padding:"3px"}}
                > Add recipe</Link>
                </button>
      <RecipesList/>
      <RecipesList/>
      ...
      <header>
        <Navbar style={sectionStyle} className="navbar">
          <Navbar.Brand>
            ...
            <button variant="link" style={{backgroundColor: "rgb(243, 223, 193)", margin:"25px", marginLeft:"10px", border:"1px solid #cccccc", borderRadius:"1.25rem" }}>
