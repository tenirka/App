...
class Profile extends React.Component {
 ...
 <Jumbotron fluid style={{ backgroundColor: "rgb(223, 206, 180)" }} >
        ...
        <Accordion className="accordion" >
          <Card >
            <Card.Header >
              <Accordion.Toggle as={Button} variant="link" eventKey="0" style={{backgroundColor:"rgb(255, 234, 217)"}}>
          ...
          <Card>
            <Card.Header>
              <Accordion.Toggle as={Button} variant="link" eventKey="1" style={{backgroundColor:"rgb(255, 234, 217)"}}>
