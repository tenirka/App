import React, { PureComponent, TableRow, FileInput } from "react";
        ...
        <Jumbotron fluid style={{ backgroundColor: "rgb(223, 206, 180)" }}>
          ...
          >
            <div>
              ...
              <Accordion
                className="accordion"
                style={{ width: "800px", margin: " 0 75px" }}
              >
                <Card>
                  <Card.Header
                    style={{ backgroundColor: "rgb(255, 234, 217)" }}
                  >
            ...
            <div>
              ...
              <Accordion
                className="accordion"
                style={{ width: "800px", margin: " 0 10px" }}
              >
                <Card>
                  <Card.Header
                    style={{ backgroundColor: "rgb(255, 234, 217)" }}
