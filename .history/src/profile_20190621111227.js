                ...
                <Card>
                  ...
                  >
                    <Accordion.Toggle as={Button} variant="link" eventKey="0">
                      <p style={{ fontFamily: "serif", color:"black", fontWeight:"550", fontSize:"20px" }}>First recipe</p>
                    </Accordion.Toggle>
                  </Card.Header>
                ...
                <Card>
                  ...
                  >
                    <Accordion.Toggle as={Button} variant="link" eventKey="1">
                      <p style={{ fontFamily: "serif", color:"black", fontWeight:"550", fontSize:"20px" }}>Second recipe</p>
                    </Accordion.Toggle>
                  </Card.Header>
