...
class Profile extends React.Component {
 ...
 <Jumbotron fluid style={{ backgroundColor: "rgb(223, 206, 180)" }} >
        ...
        <div  style={{
          ...
          <div>
            <h3 style={{ marginLeft: "35%", marginTop: "3%", fontFamily: "serif" }}>My recipes:</h3>
        <Accordion className="accordion" style={{width:"600px", margin:" 0 100px"}}>
          <Card >
        ...
        <Accordion className="accordion" style={{width:"600px", margin:" 0 10px"}}>
          <Card >
            <Card.Header style={{backgroundColor:"rgb(255, 234, 217)" }}>
              <Accordion.Toggle as={Button} variant="link" eventKey="0">
               <p style={{fontFamily: "serif", }}>First recipe</p> 
