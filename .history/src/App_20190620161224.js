      ...
      >
        <Container style={{margin:"5px", width:"25%"}}>
          <div style={{
           ...
           <div style={{margin:"20px"}}><img src={cook} alt="" style={{width:"90px", height:"90px", borderRadius:"50%"}}/> </div> 
           <div style={{margin:"5px"}}><p style={{color:"rgb(129, 131, 126)", fontFamily:"serif"}}>
            Here you will find many new culinary ideas,
            become the author ofyour own Culinary Book,
            meet like-minded friends and you can chat
            about everything in the world!
          </p> </div>
             <div style={{margin:"5px"}}><p style={{color:"rgb(129, 131, 126)", fontFamily:"serif", fontSize:"10px"}}>© 2019 ООО «Homecookin.ru» — delicious recipes. All rights reserved</p></div>
          </div>
